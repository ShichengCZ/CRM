            ...
            success:function (data) {
                ...
                $.each(data,function (i,n) {
                    ...
                    javascript:void(0)
                        ...
                        原则：
                            在动态生成的超链接中，我们直接使用触发事件即可
                            而对于动态生成的语句，参数必须在套在引号之内
                     */
                    ...
                    html +='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s' + n.id + '"> '+ (n.editFlag? n.createTime:n.editTime)+' 由'+ (n.editFlag? n.createBy:n.editBy) +'</small>';
                    html +='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
