...
<script type="text/javascript">
	...
	$(function(){
		...
		//为关联市场活动模态窗口中的搜索框来绑定事件，通过触发回车键来查询并展现所需市场活动列表

		$("#aname").keydown(function (event) {
		    if (event.keyCode == 13){

				var searchContent = $("#aname").val();
				var id = "${clue.id}";
		        $.ajax({
					url:"workbench/clue/getActivityListByContentAndNoAso.do",
					dataType:"json",
					type:"get",
					data:{
        ...
        $("#actTable").on("click",$("input[name=xz]"),function () {
		        ...
		        $.ajax({
					...
					success:function (data) {
					    ...
					    if (data.success){
					        ...
					        //清除搜索框中的信息 复选框中的勾花掉，清空activitySearchBody中的内容
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form" id="addForm">
