...
<script type="text/javascript">
    ...
    function changeStage(stage,i) {
        $.ajax({
			...
			data:{
			    ...
			    "stage":stage,
				"money":${t.money},
				"expectedDate":"${t.expectedDate}"	//生成交易历史
			},
			success:function (data) {
				/*
				data
				...
				if(data.success){
				    ...
				    //改变阶段成功，需要在详细信息页上局部刷新哪些信息呢？刷新阶段，可能性，修改人，修改事件
    ...
    function changeIcon(stage,index1) {
		...
		//如果当前阶段的可能性为0,前7个一定是黑圈,后两个一个是红×，一个是黑×
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if ("0".equals(currentPossibility)){
			    //如果当前阶段可能性为0，前七个一定是黑圈，后两个一个红×，一个黑×
			...
			<%
			    ...
			    //如果当前阶段的可能性不为0，前7个有可能是绿圈，绿色标记，黑拳，后两个一定是黑×
				//准备当前阶段的下标
				int index = 0;
