...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function () {
		    ...
		    $("#hiddenowner").val($.trim($("#owner").val()));
		    $("#hiddenname").val($.trim($("#name").val()));
		    $("#hiddencustomer").val($.trim($("#customer").val()));
		    $("#hiddenstage").val($.trim($("#stage").val()));
		    $("#hiddentype").val($.trim($("#type").val()));
		    $("#hiddensource").val($.trim($("#create-clueSource").val()));
		    $("#hiddencontacts").val($.trim($("#contact").val()));
    ...
    function pageList(pageNo,pageSize) {
        ...
        var customer = $("#hiddencustomer").val();
        var stage = $("#hiddenstage").val();
        var type = $("#hiddentype").val();
        var source = $("#hiddensource").val();
        var contact = $("#hiddencontacts").val();
...
<body>
<input id="hiddenowner" type="hidden">
<input id="hiddenname" type="hidden">
<input id="hiddencustomer" type="hidden">
<input id="hiddentype" type="hidden">
<input id="hiddenstage" type="hidden">
<input id="hiddensource" type="hidden">
<input id="hiddencontacts" type="hidden">
